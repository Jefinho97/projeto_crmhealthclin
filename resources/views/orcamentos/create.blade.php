...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="{{ route('orcamentos.store') }}" method="POST" id="add-orcamento-form"  autocomplete="off">
        @csrf
        ...
        <div class="form-group" >
            Orçamento com equipe médica:<input type="checkbox" name="tipo" value="1" id="show">
        </div>
        <div class="form-group" id="medprof">
...
<script>
    ...
    $(function(){
        ...
        //ADD NEW COUNTRY
        $('#add-orcamento-form').on('submit', function(e){
                    e.preventDefault();
                    var form = this;
                    $.ajax({
